...
func main() {
	...
	//repository
	checklistRepository := repository.NewChecklistRepositoryImpl(database)
	...
	//service
	checklistService := service.NewChecklistServiceImpl(&checklistRepository)
